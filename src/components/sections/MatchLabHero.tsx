...
const MatchLabHero = () => {
    ...
    return (
        <div className="bg-[#F3F3F3] selection:bg-black selection:text-white relative overflow-hidden">
            ...
            <section
                className="relative px-6 md:px-12 pt-[150px] pb-12 z-20 bg-[#F3F3F3]"
            ...
            >
                <div className="max-w-[1440px] mx-auto">
                    <div className="max-w-4xl">
                        ...
                        <div className="max-w-3xl space-y-8 text-[#555]">
            ...
            {/* 2. The Image Section */}
            <div
                className="relative z-10 max-w-[1440px] mx-auto px-6 md:px-12"
                style={{
                    marginTop: '-150px',
