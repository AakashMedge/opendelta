        ...
        <section className="bg-[#F9F9F9] py-12 border-t border-black/5">
            <div className="max-w-[1440px] mx-auto px-6 md:px-12">
                <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    {/* Copyright */}
                    <div className="flex flex-col items-center justify-center text-[11px] font-black tracking-[0.2em] md:absolute md:left-1/2 md:-translate-x-1/2 uppercase">
                        <div><span className="text-[#FF8C00]">OPEN</span> <span className="text-[#555]">DELTA @2026</span></div>
