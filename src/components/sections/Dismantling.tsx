...
const Dismantling = () => {
    return (
        <section className="bg-[#EBEBEB] py-20 lg:py-32 px-6 md:px-12 lg:px-20">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <ul className="space-y-4">
                                <li className="text-[16px] md:text-[18px] text-[#555] leading-relaxed pl-6 relative before:content-[''] before:absolute before:left-0 before:top-3 before:w-2 before:h-[2px] before:bg-black">
