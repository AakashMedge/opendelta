...
const BlogHero = () => {
    return (
        <section className="relative min-h-[80vh] flex items-center bg-[#F8F9FA] overflow-hidden">
            ...
            <div className="relative z-10 max-w-[1440px] mx-auto px-6 md:px-12 w-full pt-[150px] pb-32">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
                    <div className="lg:col-span-8">
                        {/* Eyebrow */}
                        <div className="flex items-center gap-4 mb-8">
                            <div className="h-px w-12 bg-[#F90]" />
                            <span className="text-[11px] font-black tracking-[0.3em] text-[#1A1A1A] uppercase">
                        ...
                        <p className="text-[18px] md:text-[20px] leading-relaxed text-[#555] font-medium max-w-2xl border-l-2 border-black/10 pl-8 ml-2">
            ...
            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4">
                ...
                <span className="text-[9px] font-black tracking-[0.4em] text-black/40 uppercase vertical-text">Scroll</span>
            </div>
        </section>
    );
};
